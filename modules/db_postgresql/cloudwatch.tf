...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  alarm_name          = "rds-${aws_db_instance.main.identifier}-CPUHigh"
...
resource "aws_cloudwatch_metric_alarm" "memory_low" {
  alarm_name          = "rds-${aws_db_instance.main.identifier}-MemoryLow"
...
resource "aws_cloudwatch_metric_alarm" "disk_space_low" {
  alarm_name          = "rds-${aws_db_instance.main.identifier}-DiskSpaceLow"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = 1
...
resource "aws_cloudwatch_metric_alarm" "write_iops_high" {
  alarm_name          = "rds-${aws_db_instance.main.identifier}-DiskWriteIOPSHigh"
  comparison_operator = "GreaterThanThreshold"
...
resource "aws_cloudwatch_metric_alarm" "read_iops_high" {
  alarm_name          = "rds-${aws_db_instance.main.identifier}-DiskReadIOPSHigh"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = 5
